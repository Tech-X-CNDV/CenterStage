...
public class audienceBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence purpleRight = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .forward(10)
                .splineTo(new Vector2d(-43.5,40),Math.toRadians(-135))
                .setReversed(true)
                ...
                .addDisplacementMarker(()->{
                    robot.leftSliderMotor.setTargetPosition(robot.presetPos+350);
                    robot.rightSliderMotor.setTargetPosition(robot.presetPos+350);
                })
                .splineTo(new Vector2d(45, 29.5),Math.toRadians(0))
                .addDisplacementMarker(()->{
        ...
        TrajectorySequence purpleLeft = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .forward(10)
                .splineTo(new Vector2d(-27,40),Math.toRadians(-45))
                .setReversed(true)
                .splineTo(new Vector2d(-35.5,50),Math.toRadians(90))
                .setReversed(false)
                .forward(34)
       ...
       // robot.clawServo.setPosition(0);
        ...
        while(!isStopRequested() && robot.leftSliderMotor.getCurrentPosition()>robot.errorMargin)
        {
            robot.leftSliderMotor.setTargetPosition(0);
            robot.rightSliderMotor.setTargetPosition(0);
        }
