...
public class farRED extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Trajectory rightSpike = drive.trajectoryBuilder(startPose)
                ...
                .build();
        Trajectory rightBack = drive.trajectoryBuilder(rightSpike.end())
                .back(5)
                .build();
        Trajectory rightRepo = drive.trajectoryBuilder(rightBack.end(),true)
                .splineTo(new Vector2d(18,10),Math.toRadians(0))
        TrajectorySequence rightDrive0 = drive.trajectorySequenceBuilder(rightRepo.end())
                .forward(78)
                .build();
        TrajectorySequence rightDrive1 = drive.trajectorySequenceBuilder(rightDrive0.end())
                .strafeLeft(35)
                .build();
